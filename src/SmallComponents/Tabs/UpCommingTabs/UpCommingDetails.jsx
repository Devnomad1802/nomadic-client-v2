...
const UpcommingDetails = () => {
  ...
  return (
    <Box>
      ...
      {/* Left: trip info + all detail tabs | Right: sticky booking card */}
      <Container maxWidth="xl">
        <Grid container spacing={4} sx={{ alignItems: "flex-start" }}>

          {/* LEFT COLUMN — trip info + detail sections */}
          <Grid item xs={12} md={8}>
            ...
            {/* Pickup / Drop-off */}
            <Box sx={{ background: "#F9FAFB", border: "1px solid #F3F4F6", borderRadius: "32px", display: "flex", alignItems: "center", gap: 1, py: 1, px: 2, mt: 2, width: "fit-content" }}>
            ...
            {/* Detail tabs (Overview, Itinerary, Batch, Inclusions, Gallery, Reviews) */}
            <Box sx={{ mt: 4 }}>
          ...
          <Grid item xs={12} md={4} sx={{ display: { xs: "none", md: "block" } }}>
            ...
            >
              ...
              <Box sx={{ display: "flex", alignItems: "baseline", gap: 1 }}>
                <Typography sx={{ color: "#1F2937", fontWeight: 700, fontSize: "30px", fontFamily: "Inter" }}>
                  &#8377;{item?.price}
                </Typography>
                {item?.strikePrice && Number(item.strikePrice) > Number(item.price) && (
                  <Typography sx={{ color: "#9CA3AF", fontSize: "16px", textDecoration: "line-through", fontFamily: "Inter" }}>
                    &#8377;{item.strikePrice}
                  </Typography>
                )}
                <Typography sx={{ color: "#6B7280", fontSize: "14px", fontFamily: "Inter" }}>/ person</Typography>
              </Box>
